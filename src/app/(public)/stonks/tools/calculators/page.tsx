...
import ROICCalculatorWrapper from "@/components/stonks/tools/calculators/roic/wrapper";
import FIRECalculatorWrapper from "@/components/stonks/tools/calculators/fire/wrapper";
